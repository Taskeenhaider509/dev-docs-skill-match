...
import LinkIconComponent from '/src/components/LinkComponent/LinkIconComponent';
...
<LinkIconComponent  text="Click Here"url="https://www.skillmatch.tech/dashboard/company" />
